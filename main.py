...
def attack(char_name: str, char_class: str) -> str:
    ...
    It depends on chosen type of a hero.
    """
...
def special(char_name: str, char_class: str) -> str:
    """Return points of special skills.
    It depends on type of chosen hero.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Return description of chosen type of a hero.
    Makes communication with player for choosing of commands for training.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Make communication with player for choosing of type of a hero."""
